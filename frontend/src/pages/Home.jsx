				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<motion.p
							...
							variants={textVariants}
						>
							We're not just another coffee shop. Discover what makes our craft coffee
							experience special.
						</motion.p>
					</motion.div>
					...
					>
						...
						>
							...
							<div className="relative z-10 bg-gradient-to-t from-[#fff8] via-[#fff6] to-[#fff0] p-8 pt-32 text-center">
								<h3 className="text-2xl font-bold text-[#3e2723] mb-3 drop-shadow">
									Premium Ingredients
								</h3>
								<p className="text-[#5d4037] font-medium drop-shadow">
									We source only the finest coffee beans and ingredients, ensuring
									a premium experience with every sip.
								</p>
							</div>
						</motion.div>
						...
						>
							...
							<div className="relative z-10 bg-gradient-to-t from-[#fff8] via-[#fff6] to-[#fff0] p-8 pt-32 text-center">
								...
								<p className="text-[#5d4037] font-medium drop-shadow">
									Create your perfect drink with our intuitive customization
									options. Your coffee, your way.
								</p>
							</div>
						</motion.div>
						...
						>
							...
							<div className="relative z-10 bg-gradient-to-t from-[#fff8] via-[#fff6] to-[#fff0] p-8 pt-32 text-center">
								...
								<p className="text-[#5d4037] font-medium drop-shadow">
									We're committed to eco-friendly practices from bean to cup,
									ensuring a positive impact on our community.
								</p>
							</div>
						</motion.div>
					</motion.div>
						...
						{popularDrinks.map((drink, index) => (
							...
							>
								...
								<div className="p-6 text-center">
									...
									<div className="text-[#cc6d2d] font-bold text-lg mb-4">
										{drink.price}
									</div>
									<button
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{testimonials.map((testimonial, index) => (
							...
							>
								<div className="absolute -top-5 left-8 text-6xl text-[#cc6d2d] opacity-30">
									"
								</div>
								<p className="text-[#5d4037] mb-6 relative z-10">
									"{testimonial.quote}"
								</p>
			...
			<section className="py-24 px-6 bg-[#3e2723] text-white">
				...
				>
					...
					<motion.p
						...
						variants={textVariants}
					>
						Join thousands of coffee lovers who have discovered their perfect brew with
						BrewCrafter
					</motion.p>
					<motion.div
