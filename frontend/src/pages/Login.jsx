  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-76px)] bg-[#f8e8d0] px-4 py-12">
      <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl w-full max-w-md border border-[#e4c9a7]/20">
        <h2 className="text-3xl font-bold text-center mb-8 text-[#3e2723]">Welcome <span className="text-[#cc6d2d]">Back!</span></h2>
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <div className="flex justify-end mt-2">
              <Link to="/forgot-password" className="text-sm text-[#cc6d2d] hover:text-[#3e2723] transition-colors duration-200">
                Forgot Password?
              </Link>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-[#5d4037]">
            ...
            <Link to="/register" className="text-[#cc6d2d] font-semibold hover:text-[#3e2723] transition-colors duration-200">
              Sign Up
            </Link>
          </p>
        </div>
        ...
        <div className="mt-6 relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white px-4 text-sm text-[#5d4037]">or continue with</span>
          </div>
        </div>
