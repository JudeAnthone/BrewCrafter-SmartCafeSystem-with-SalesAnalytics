...
const Craft = () => {
  ...
  }, [craftedDrink.base, craftedDrink.size, craftedDrink.milk, craftedDrink.sweetener, craftedDrink.toppings, craftedDrink.extras]);
  ...
  const milkOptions = ['Whole Milk', 'Almond Milk', 'Oat Milk', 'Coconut Milk', 'Soy Milk', 'None'];
  const sweetenerOptions = ['Sugar', 'Honey', 'Maple Syrup', 'Stevia', 'None'];
  const toppingOptions = ['Whipped Cream', 'Chocolate Drizzle', 'Caramel Drizzle', 'Cinnamon', 'Cocoa Powder', 'Sprinkles'];
  const extraOptions = ['Extra Shot', 'Vanilla Syrup', 'Hazelnut Syrup', 'Caramel Syrup', 'Chocolate Syrup', 'Mint Syrup'];
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          ...
          {currentStep === 1 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Choose Your Base</h2>
              <p className="text-gray-600 mb-6">Select the foundation of your drink</p>
                ...
                {drinkBases.map(base => (
                  <label 
                    ...
                    className={`bg-[#f8f4e5] p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                      craftedDrink.base === base ? 'ring-2 ring-[#3e2723] shadow-md' : ''
                    }`}
                  >
                    <input
                      type="radio"
                    ...
                    <div className="flex flex-col items-center text-center">
                      <span className="text-lg font-medium text-[#3e2723]">{base}</span>
                      {base === 'Espresso' && <span className="text-sm text-gray-500">Rich, strong coffee shot</span>}
                      {base === 'Cold Brew' && <span className="text-sm text-gray-500">Smooth, less acidic coffee</span>}
                      {base === 'Matcha' && <span className="text-sm text-gray-500">Earthy green tea powder</span>}
                      {base === 'Tea' && <span className="text-sm text-gray-500">Black, green, or herbal</span>}
                      {base === 'Chocolate' && <span className="text-sm text-gray-500">Rich cocoa base</span>}
                    </div>
                  </label>
                ))}
              </div>
          ...
          {currentStep === 2 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Choose Your Size</h2>
                ...
                {drinkSizes.map(size => (
                  <label 
                    ...
                    className={`flex flex-col items-center cursor-pointer transition-all duration-200 ${
                      craftedDrink.size === size ? 'text-[#3e2723] font-medium' : 'text-gray-500'
                    }`}
                  >
                    <div 
                    ...
                    >
                      <div 
                        className={`bg-[#e4c9a7] rounded-lg transition-all duration-200 ${
                          size === 'Small' ? 'h-16 w-10' : 
                          size === 'Medium' ? 'h-20 w-12' : 
                          'h-24 w-14'
                        }`}
                      ></div>
                    </div>
          ...
          {currentStep === 3 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Choose Your Milk</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {milkOptions.map(milk => (
                  <label 
                    key={milk} 
                    className={`bg-[#f8f4e5] p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                      craftedDrink.milk === milk ? 'ring-2 ring-[#3e2723] shadow-md' : ''
                    }`}
                  >
                    <input
                      type="radio"
                    ...
                    <div className="flex items-center">
                      ...
                      {milk !== 'None' && milk !== 'Whole Milk' && (
                        <span className="ml-auto text-sm text-gray-500">+₱{milk === 'Soy Milk' ? '10' : '15'}</span>
                      )}
                    </div>
                  </label>
                ))}
          ...
          {currentStep === 4 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Choose Your Sweetener</h2>
              <p className="text-gray-600 mb-6">How would you like to sweeten your drink?</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {sweetenerOptions.map(sweetener => (
                  <label 
                    key={sweetener} 
                    className={`bg-[#f8f4e5] p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                      craftedDrink.sweetener === sweetener ? 'ring-2 ring-[#3e2723] shadow-md' : ''
                    }`}
                  >
                    <input
                      type="radio"
                    ...
                    <div className="flex items-center">
                      ...
                      {sweetener !== 'None' && sweetener !== 'Sugar' && (
                        <span className="ml-auto text-sm text-gray-500">
                          +₱{sweetener === 'Honey' || sweetener === 'Stevia' ? '5' : '10'}
                        </span>
                      )}
                    </div>
                  </label>
          ...
          {currentStep === 5 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Choose Your Toppings</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {toppingOptions.map(topping => (
                  <label 
                    key={topping} 
                    className={`bg-[#f8f4e5] p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                      craftedDrink.toppings.includes(topping) ? 'ring-2 ring-[#3e2723] shadow-md' : ''
                    }`}
                  >
                    <input
                      type="checkbox"
          ...
          {currentStep === 6 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Choose Your Add-ins</h2>
              <p className="text-gray-600 mb-6">Enhance your drink's flavor (₱15 each)</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {extraOptions.map(extra => (
                  <label 
                    key={extra} 
                    className={`bg-[#f8f4e5] p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                      craftedDrink.extras.includes(extra) ? 'ring-2 ring-[#3e2723] shadow-md' : ''
                    }`}
                  >
                    <input
                      type="checkbox"
          ...
          {currentStep === 7 && (
            <div className="animate-fadeIn">
              <h2 className="text-2xl font-semibold text-[#3e2723] mb-4">Final Touches</h2>
              
              <div className="mb-6">
                <h3 className="text-lg font-medium text-[#3e2723] mb-2">Temperature</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {temperatureOptions.map(temp => (
                    <label 
                      key={temp} 
                      className={`bg-[#f8f4e5] p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md ${
                        craftedDrink.temperature === temp ? 'ring-2 ring-[#3e2723] shadow-md' : ''
                      }`}
                    >
                      <input
                        type="radio"
              ...
              <div className="mb-6">
                <h3 className="text-lg font-medium text-[#3e2723] mb-2">Name Your Creation</h3>
                <input
                  type="text"
                  name="name"
                ...
                {craftedDrink.base ? (
                  <div className="relative w-1/2 h-3/4">
                    <div className={`absolute inset-0 rounded-t-lg ${
                      craftedDrink.temperature === 'Hot' ? 'bg-[#B25D48]' : 
                      craftedDrink.temperature === 'Iced' ? 'bg-[#7BA0C9]' : 
                      'bg-[#9C8277]'
                    }`} style={{ height: '90%' }}></div>
                    <div className={`absolute inset-x-0 top-0 rounded-t-lg ${
                      craftedDrink.base === 'Espresso' ? 'bg-[#3A2218]' : 
                      craftedDrink.base === 'Cold Brew' ? 'bg-[#5D4037]' : 
                      craftedDrink.base === 'Matcha' ? 'bg-[#8BC34A]' : 
                      craftedDrink.base === 'Tea' ? 'bg-[#D1A067]' : 
                      'bg-[#6D4C41]'
                    }`} style={{ height: '30%' }}></div>
                    {craftedDrink.milk && craftedDrink.milk !== 'None' && (
                      <div className="absolute inset-x-0 bottom-0 bg-[#F5F5DC]" style={{ height: '30%' }}></div>
                    )}
                    {craftedDrink.toppings.includes('Whipped Cream') && (
                      <div className="absolute inset-x-0 -top-4 h-8 bg-white rounded-t-full"></div>
                    )}
                    {(craftedDrink.toppings.includes('Chocolate Drizzle') || craftedDrink.toppings.includes('Caramel Drizzle')) && (
                      <div className="absolute inset-x-0 top-0 flex justify-center">
                        <div className={`w-1/2 h-6 ${
                          craftedDrink.toppings.includes('Chocolate Drizzle') ? 'bg-[#3A2218]' : 'bg-[#C87F0E]'
                        } opacity-70 rounded-full`}></div>
                      </div>
                    )}
                    <div className="absolute inset-0 border-2 border-[#3e2723] rounded-t-lg" style={{ height: '90%' }}></div>
                    <div className="absolute inset-x-0 bottom-0 h-2 bg-[#3e2723] rounded-b-lg transform translate-y-full"></div>
                  </div>
                ) : (
                  <p className="text-gray-500 text-center p-4">Select ingredients to see your drink</p>
                )}
              </div>
            </div>
            
            <div className="w-full md:w-2/3">
              <h3 className="text-xl font-semibold text-[#3e2723] mb-2">{craftedDrink.name || 'Custom Drink'}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 mb-4">
                ...
                {craftedDrink.sweetener && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{craftedDrink.sweetener}</span>
                  </div>
                )}
                ...
                {craftedDrink.temperature && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{craftedDrink.temperature}</span>
                  </div>
                )}
              </div>
              ...
              {craftedDrink.toppings.length > 0 && (
                <div className="mb-3">
                  <h4 className="text-sm font-semibold text-[#3e2723] mb-1">Toppings:</h4>
                  <div className="flex flex-wrap gap-2">
                    {craftedDrink.toppings.map(topping => (
                      <span key={topping} className="bg-[#f8e8d0] text-[#3e2723] px-2 py-1 rounded-full text-xs">
                        {topping}
                      </span>
                    ))}
                  </div>
              ...
              {craftedDrink.extras.length > 0 && (
                <div className="mb-3">
                  <h4 className="text-sm font-semibold text-[#3e2723] mb-1">Add-ins:</h4>
                  <div className="flex flex-wrap gap-2">
                    {craftedDrink.extras.map(extra => (
                      <span key={extra} className="bg-[#f8e8d0] text-[#3e2723] px-2 py-1 rounded-full text-xs">
                        {extra}
                        </span>
                    ))}
                  </div>
              ...
              <div className="flex justify-between items-center mt-4">
                <span className="text-lg font-semibold text-[#3e2723]">Total Price:</span>
                <span className="text-xl font-bold text-[#3e2723]">₱{craftedDrink.price}</span>
              </div>
            </div>
          </div>
        </div>
